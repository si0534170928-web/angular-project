...
export const routes: Routes = [
    ...
    {path:'projects/:id',component:ProjectDetails,canActivate:[authGuard], data: { prerender: false }},
    {path:'projects/:id/tasks/:taskId',component:TaskDetail,canActivate:[authGuard], data: { prerender: false }},
